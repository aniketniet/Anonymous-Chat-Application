...
const Home = () => {
        ...
        <div className="container mx-auto px-8 lg:flex">
          <div className="text-center lg:text-left lg:w-1/2">
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none uppercase">
              Chat anyone with Anonymity
            </h1>
            <p className="text-xl lg:text-2xl mt-6 font-light">
              Now you can chat with anyone without revealing your identity and
  ...
  text-white"
            ...
            <p className="mt-4 text-gray-600">Signup to get Started.</p>
          </div>
      ...
      <section className="bg-gray-100 py-8">
        <div className="container mx-auto text-center px-4">
          <h2 className="text-5xl font-bold text-gray-800 mb-8 mt-8">
            Features
          </h2>
          <div className="flex flex-wrap -mx-4">
            <div className="w-full md:w-1/3 px-4 mb-8">
              <div className="bg-white p-8 shadow-md rounded-md">
                ...
                <p className="text-gray-600">
                  Chat anyone without worrying about your privacy and security.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/3 px-4 mb-8">
              <div className="bg-white p-8 shadow-md rounded-md">
                ...
                <p className="text-gray-600">
                  Connect with people from all over the world and make new
                  friends.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/3 px-4 mb-8">
              <div className="bg-white p-8 shadow-md rounded-md">
                <i className="fa fa-duotone fa-robot text-4xl text-blue-500 mb-4" />
                <h3 className="text-xl font-bold text-gray-800 mb-2">
                  AI Powered Chat
                </h3>
                <p className="text-gray-600">
                  Chat with AI powered chatbots and have fun conversations and
                  ask daily questions.
                </p>
              </div>
            </div>
      ...
      <div className="p-10 max-w-screen-lg mx-auto">
        <div className="text-center mb-4">
          <h3 className="text-3xl sm:text-5xl leading-normal font-extrabold tracking-tight text-gray-900">
            About<span className="text-indigo-600"> Team</span>
          </h3>
        </div>
        <div className="sm:grid grid-cols-2 gap-6 my-10">
          <div className="max-w-sm w-full lg:max-w-full lg:flex mx-auto my-10">
            <div
              ...
              style={{
                backgroundImage:
                  'url("https://images.pexels.com/photos/3785084/pexels-photo-3785084.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500")',
              }}
		...
		C93.282,101.457,89.661,116.261,93.282,126.483z"
          ...
          <div className="max-w-sm w-full lg:max-w-full lg:flex mx-auto my-10">
            <div
              ...
              style={{
                backgroundImage:
                  'url("https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500")',
              }}
              title="Woman holding a mug"
            ></div>
            <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4">
              <div className="">
                ...
                <p className="text-gray-500 text-base mt-4">
                  Build beautiful and responsive websites with me.
                </p>
                <div className="my-4 flex">
                  <a href="#">
                    <svg
      ...
      <footer className="bg-gray-900 text-white py-4">
        <div className="container mx-auto px-4">
          <p className="text-center">
            YourApp &copy; 2024. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
